# Makefile for Cielo Azure Billing Data Project
...
# Project directories
PROJECT_DIR := .
APPS_DIRS := billing caching

.PHONY: help clean clean-pyc clean-build clean-db clean-logs install migrate runserver test lint format tarball
...
# Import Azure billing data (example command, adjust as needed)
import-billing-data:
	$(MANAGE) import_billing_data
