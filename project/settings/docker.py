# Docker-specific settings for CieloAzureBillingData
from .base import *
import os
...
CACHES = {
    'default': {
        ...
        'LOCATION': f"redis://{os.environ.get('REDIS_HOST', 'redis')}:6379/2",
    }
}
...
ALLOWED_HOSTS = [
    'billing.dev.viloforge.com',
    'azurebilling.dev.viloforge.com',
    'billing.cielo.test',
    'localhost',
    '127.0.0.1',
    'cielo_billing',  # Docker service name
...
IDENTITY_PROVIDER_URL = 'https://identity.dev.viloforge.com'
IDENTITY_PROVIDER_INTERNAL_URL = 'http://cielo_identity:8002'  # Internal Docker communication

# Azure Billing specific settings
AZURE_STORAGE_CONNECTION_STRING = os.environ.get('AZURE_STORAGE_CONNECTION_STRING', '')
AZURE_CONTAINER_NAME = os.environ.get('AZURE_CONTAINER_NAME', 'billing-data')
